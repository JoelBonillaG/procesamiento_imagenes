...
\begin{equation}
    ...
    \label{eq:grises}
\end{equation}
El resultado descarta el color y conserva la información de brillo, lo que facilita la observación de zonas claras y oscuras, bordes y manchas presentes en la imagen \cite{b2}. Sobre esta representación se aplica además una compresión por bloques, que agrupa los píxeles en regiones de tamaño $N \times N$ y las reemplaza por su valor promedio, reduciendo la cantidad total de datos mientras se mantienen los rasgos generales de la retina.
